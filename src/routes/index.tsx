  ...
  head: () => ({
    meta: [
      { title: "Barbería Olympus Armilla | Barbería en Granada" },
      {
        name: "description",
        content:
          "Barbería Olympus en Armilla, Granada. Cortes, arreglo de barba y afeitado clásico. Av. de Pte., 2, BAJO 1. Reserva tu cita: 611 869 405.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          address: {
            "@type": "PostalAddress",
            streetAddress: "Av. de Pte., 2, BAJO 1",
      ...
      <section id="inicio" className="relative flex min-h-screen items-center">
        ...
        <div className="relative mx-auto w-full max-w-6xl px-6 pt-28 pb-20 text-center">
          <img
            ...
            width={260}
            height={260}
            className="mx-auto w-52 mix-blend-screen md:w-64"
          />
        ...
        <div className="grid gap-12 md:grid-cols-2 md:items-center">
          ...
          <div className="overflow-hidden border border-border">
            <iframe
              ...
              src="https://www.google.com/maps?q=Av.%20de%20Pte.%202,%20BAJO%201,%20Armilla,%2018100%20Granada&output=embed"
              loading="lazy"
