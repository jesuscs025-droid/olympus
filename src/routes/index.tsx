...
function Index() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-24 md:grid-cols-2">
          ...
          <div className="flex flex-col justify-center border border-border bg-card p-10 text-center">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Llámanos o escríbenos por Instagram y te buscamos hueco.
            </p>
      ...
      {/* CTA fijo en móvil */}
      <div className="fixed inset-x-0 bottom-0 z-50 flex gap-2 border-t border-border bg-background/95 p-3 backdrop-blur-md md:hidden">
        <a
          href={calUrl(CAL_LINK)}
          target="_blank"
          rel="noopener noreferrer"
          data-cal-link={CAL_LINK}
          className="btn-gold flex-1 !px-3 !py-3 text-[0.7rem]"
        >
          Reservar cita
        </a>
        <a href="tel:+34611869405" className="btn-ghost-gold !px-4 !py-3 text-[0.7rem]">
